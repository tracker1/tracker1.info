...
<p>This is Part 2 in a series on creating a web application utilizing modern  techniques in order to deliver a fast, cohesive site.  The index for this series  can be found at the end of <a href="/post/2010/10/25/modern-web-apps-part001/" test="true">part 1 in this series</a>.</p>
<p><img style="float:left; margin-right:0.5em;" src="./files/files.png" alt="file structure" test="true"></p>
<div><a href="./files/demo/index.html" test="true">View the Part2 demo page.</a> <br> <a href="./files/part2-demo.zip" test="true">Download the Part2 demo.</a></div>
